                              ...
                              const char *buf, size_t count)
{
    ...
    printk("%s: usr value : %d\n", __func__, (int)value);
    gpio_direction_output(dev_data->en_pin, !!value);
    dev_data->gpio_val = !!value;
...
static DEVICE_ATTR(gpio_en, S_IWUSR|S_IRUSR, gpio_show_en, gpio_store_en);
